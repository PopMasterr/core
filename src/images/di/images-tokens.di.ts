export class ImagesDiTokens {
    public static readonly MySQLImagesRepositoryInterface: string = 'MySQLImagesRepositoryInterface';
    public static readonly ImagesRepositoryInterface: string = 'ImagesRepositoryInterface'; 
